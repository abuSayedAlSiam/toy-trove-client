...
const Footer = () => {
  return (
    <footer className="relative z-10 pt-8 bg-sky-100 ">
        ...
        <div className="-mx-4 flex flex-wrap">
          <div className="w-full px-4 sm:w-2/3 lg:w-5/12">
            <div className="mb-10 w-full">
              ...
              Toy Trove: Unleash the magic of play with our curated collection of quality toys. Ignite imagination, learning, and endless fun for children of all ages.
              </p>
