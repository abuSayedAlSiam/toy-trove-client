          ...
          <div className="w-full px-4 sm:w-2/3 lg:w-4/12">
            <div className="mb-10 w-full">
              ...
              <p className="text-body-color mb-7 text-base">
                <span className='font-semibold'>Toy Trove:</span> Unleash the magic of play with our curated collection of quality toys. Ignite imagination, learning, and endless fun for children of all ages.
              </p>
          ...
          <div className="w-full px-4 sm:w-1/2 lg:w-3/12">
            <div className="mb-10 w-full">
              ...
              <ul>
                ...
                <li>
                  <span className="text-body-color mb-2 inline-block text-base leading-loose">
                    Address: 123 Toy Street, City, Country
                  </span>
                </li>
              </ul>
            </div>
          ...
          <div className="w-full px-4 sm:w-1/2 lg:w-2/12">
            <div className="mb-10 w-full">
              ...
              <div className="mb-6 flex items-center">
                ...
                <Link
                  to="https://www.linkedin.com/in/abu-sayed-al-siam-411017277/"
              ...
              <p className="text-body-color text-base">&copy; 2023 Toy Trove </p>
            </div>
          </div>
        </div>
      </div>
